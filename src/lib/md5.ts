/** MD5 hex digest for KOReader auth and document IDs. */
...
function cmn(q: number, a: number, b: number, x: number, s: number, t: number): number {
  return (((a + q + x + t) >>> 0) << s) | ((a + q + x + t) >>> 0) >>> (32 - s);
}

function ff(a: number, b: number, c: number, d: number, x: number, s: number, t: number) {
  return (cmn((b & c) | (~b & d), a, b, x, s, t) + b) >>> 0;
}

function gg(a: number, b: number, c: number, d: number, x: number, s: number, t: number) {
  return (cmn((b & d) | (c & ~d), a, b, x, s, t) + b) >>> 0;
}

function hh(a: number, b: number, c: number, d: number, x: number, s: number, t: number) {
  return (cmn(b ^ c ^ d, a, b, x, s, t) + b) >>> 0;
}

function ii(a: number, b: number, c: number, d: number, x: number, s: number, t: number) {
  return (cmn(c ^ (b | ~d), a, b, x, s, t) + b) >>> 0;
}
